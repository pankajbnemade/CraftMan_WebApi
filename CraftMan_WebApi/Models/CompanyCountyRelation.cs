    ...
    public class CompanyCountyRelation
    {
        ...
        public static ArrayList GetRelationDetailByCompany(int CompanyId)
        {
            ...
            while (reader.Read())
            {
                ...
                pCompanyCountyRelation.CompanyName = (string)reader["CompanyName"];
                pCompanyCountyRelation.CountyName = (string)reader["CountyName"];
                pCompanyCountyRelation.MunicipalityName = (string)reader["MunicipalityName"];
