...
namespace CraftMan_WebApi.Models
{
    public class CompanyMaster
    {
        ...
        public static CompanyMaster GetCompanyDetail(string user)
        {
            ...
            string qstr = "  SELECT  Username      ,Password      ,Active      ,UserType      ,pCompId      ,LocationId      ,MobileNumber      ,ContactPerson      ,EmailId      ,CreatedOn      ,UpdatedOn      ,CompanyName      ,CompanyRegistrationNumber      ,CompanyPresentation      ,Logotype      ,CompetenceDescription      ,CompanyReferences      ,JobList  FROM  tblCompanyMaster where Username='" + user + "'  ";
